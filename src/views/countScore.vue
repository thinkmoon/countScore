  ...
  <div>
    ...
    >
      ...
      <div class="numberline flex">
        <div class="flex-sub justify-center flex text-l">{{competition[0].userNumber}}. {{competition[0].username}}</div>
        <div class="flex-sub justify-center flex text-l">{{competition[1].userNumber}}. {{competition[1].username}}</div>
      </div>
